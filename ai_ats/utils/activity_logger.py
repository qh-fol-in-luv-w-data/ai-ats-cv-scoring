...
Cach dung:
    ...
    logger = ActivityLogger(prefix="ATS", module="AI ATS")
    ...
    action_name = logger.start_action(session_name, action_type="generate_report",
                                      input_summary="candidate=Nguyen Van A",
                                      input_detail={"candidate": "Nguyen Van A"})
    ...
    logger.finish_action(action_name, status="success",
                         output_summary="Report da tao xong...",
...
class ActivityLogger:
    def __init__(self, prefix: str, module: str):
        """
        prefix: Tien to DocType, VD: "ATS"
        module: Ten module Frappe, VD: "AI ATS"
        """
        self.prefix = prefix
        self.module = module
